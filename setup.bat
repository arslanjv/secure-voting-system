...
echo.
echo Next steps:
echo 1. Edit .env file with your database credentials and MASTER_ENCRYPTION_KEY
echo 2. Generate SSL certificates: python generate_cert.py
echo 3. Run: python init_db.py (to initialize database)
echo 4. Run: python run.py (to start the application with HTTPS)
echo 5. Access: https://localhost:5001
echo.
